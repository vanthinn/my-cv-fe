  ...
  return (
    <div className="my-8 flex flex-col">
      ...
      <div className="mt-8 grid grid-cols-3 gap-4">
        <>
          {loading === 'LOADING_SUCCESS' && jobData.length > 0 && (
            <>
              {' '}
              {jobData.map((job, index) => (
                <div
                  ...
                  <div
                    ...
                    <span className="ml-4 text-[15px] text-blue-500 font-semibold flex-shrink-0">
                      {job.salary}
                    </span>
                  </div>
                  ...
                  <div
                    ...
                    <li className="list-none px-2 py-1 bg-blue-400 text-white rounded-md text-sm">
                      {job.experience}
                    </li>
                    <li className="list-none px-2 py-1 bg-blue-400 text-white rounded-md text-sm">
                      {job.jobType}
                  ...
                  <div
                    ...
                    <img
                      className="h-14 w-14 border object-contain border-slate-200 rounded-md"
                      src={job.company.logoUrl || default_logo}
                      alt=""
                    />
            ...
            <>
              <div className="animate-pulse border border-slate-200 px-3 py-2 flex flex-col gap-2">
                ...
                <div className="flex mt-2 gap-4">
                  <div className="h-12 w-14 flex-shrink-0 bg-gray-200 rounded" />
                  <div className="flex flex-col gap-2">
                    <div className="h-5 w-60 bg-gray-200 rounded" />
                    <div className="h-5 w-60 bg-gray-200 rounded" />
                  </div>
                </div>
                <div className="h-10 w-full mt-2 bg-gray-200 rounded" />
              </div>
              <div className="animate-pulse border border-slate-200 px-3 py-2 flex flex-col gap-2">
                <div className="flex justify-between ">
                  <div className="h-8 w-44 bg-gray-200 rounded" />
